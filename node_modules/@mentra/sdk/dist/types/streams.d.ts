 ...
 */
export declare function parseTouchEventStream(subscription: ExtendedStreamType): string | null;
/**
 * Create a touch event subscription for a specific gesture
 * @param gesture Gesture name (e.g., "forward_swipe")
 * @returns Typed stream identifier
 */
export declare function createTouchEventStream(gesture: string): ExtendedStreamType;
/**
 ...
 * @returns Typed stream identifier
 */
export declare function createUniversalTranslationStream(targetLanguage: string, options?: {
    disableLanguageIdentification?: boolean;
}): ExtendedStreamType;
/**
